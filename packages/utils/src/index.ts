import type { Solicitud, Configuracion } from '@logiflow/types'
...
export function calcularCostoSolicitud(
  sol: Pick<
    Solicitud,
    | 'etiquetasPieza'
    | 'cantidad'
...
export const ESTADO_SOL_LABEL: Record<string, string> = {
  PENDIENTE: 'Pendiente',
  ASIGNADA: 'Asignada',
  EN_RUTA: 'En Ruta',
...
export const ESTADO_COND_LABEL: Record<string, string> = {
  DISPONIBLE: 'Disponible',
  EN_RUTA: 'En Ruta',
  INACTIVO: 'Inactivo',
}

export const TIPO_SOL_LABEL: Record<string, string> = {
...
export const TIPO_VEH_LABEL: Record<string, string> = {
  TORTON: 'Tórtón',
  RABON: 'Rabón',
  VAN: 'Van',
  PICKUP: 'Pick-up',
...
export function generateOT(): string {
  const now = new Date()
